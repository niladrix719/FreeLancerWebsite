      ...
      <div className={style.body}>
        <div className={style.profileBox}>
          {!editProfile && <div className={style.form}>
            {!editProfile && <div className={style.coverPicture} style={{ backgroundImage: `url(https://fipezo-server.vercel.app/uploads/${coverPicture})` }}>
            </div>}
            {!editProfile && <div className={style.profileImage}>
              <Image className={style.dp} src={profilePicture === '' ? '/dp.png' : `https://fipezo-server.vercel.app/uploads/${profilePicture}`} alt="profile" height='1000' width='1000' />
            </div>}
          ...
          {editProfile && <div className={style.editProfile}>
            <form className={style.form} encType="multipart/form-data" onSubmit={handleEditProfile}>
              <div className={style.editCoverPicture} style={{ backgroundImage: `url(${cover ? cover : (coverPicture ? `https://fipezo-server.vercel.app/uploads/${user.coverPicture}` : '/dp.png')})` }}>
              ...
              <div className={style.editProfileImage} style={{
                backgroundImage: `url(${image ? image : (profilePicture ? `https://fipezo-server.vercel.app/uploads/${user.profilePicture}` : '/dp.png')})`,
              }}>
