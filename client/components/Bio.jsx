...
export default function Bio() {
  return (
    <div className={styles.bio}>
      <h1 className={styles.heading} style={{fontSize: '2.8rem'}}>One-Stop Platform for Freelance Talent</h1>
      <p className={styles.subHeading}>Find the Right Freelancer for Your Project with Our Easy-to-Use Platform</p>
        ...
        <div className={styles.picturesNText}>
          <div className={styles.pictures}>
            <Image id={styles.photographer} src='/PhotographerReal.jpg' width={300} height={300} alt='image' />
