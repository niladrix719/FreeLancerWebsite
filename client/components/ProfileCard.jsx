...
export default function ProfileCard(props) {
  ...
  return (
    <Link className={styles.profileCard} href={`/profile/${props.profile.uid}`} target='_blank'>
      <div className={styles.cover} style={{ backgroundImage: `url(http://localhost:3000/images/${props.profile.coverPicture})` }}></div>
      <Image className={styles.image} src={`http://localhost:3000/images/${props.profile.profilePicture}`} height='600' width='600' alt="profile-image" />
